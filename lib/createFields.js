            ...
            return register(
              ...
              function() {
                return (0, _get3.default)(
                  (0, _find3.default)(_this2.props.validate, { name: name }),
                  'funcs',
                  undefined
                )
              },
              function() {
                return (0, _get3.default)(
                  (0, _find3.default)(_this2.props.warn, { name: name }),
                  'funcs',
                  undefined
                )
              }
          ...
          if (!_plain2.default.deepEqual(this.props.names, nextProps.names)) {
            ...
            nextProps.names.forEach(function(name) {
              return register(
                ...
                function() {
                  return (0, _get3.default)(
                    (0, _find3.default)(_this3.props.validate, { name: name }),
                    'funcs',
                    undefined
                  )
                },
                function() {
                  return (0, _get3.default)(
                    (0, _find3.default)(_this3.props.warn, { name: name }),
                    'funcs',
                    undefined
                  )
                }
